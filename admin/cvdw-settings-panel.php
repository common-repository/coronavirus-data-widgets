<?php
function cvdw_countries_array(){
    $k = CVDW_get_all_country_data();
    $c_array=[];
    $c_array["World"]="World";
...
$cvct_preview_cmb2->add_field( array(
    'name' => '',
    'desc' =>cvdw_display_live_preview(),
    'type' => 'title',
    'id'   => 'cvct_live_preview'
) );
   $cvct_cmb2 = new_cmb2_box( array(
    ...
    $cvct_cmb2->add_field(array(
        ...
        'desc' => 'Enter page/post id from where you want to disable ticker(only for footer/header position)',
    ...
    function cvdw_display_live_preview(){
        $output='';
